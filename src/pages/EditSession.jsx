  ...
  const uploadNewFiles = async () => {
    ...
    for (const item of newFiles) {
      try {
        ...
        updateNewFile(item.id, { progress: 100, status: 'success' })
      } catch (fileError) {
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            <button
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-md border border-rose-300 bg-white px-4 py-2.5 text-sm font-medium text-rose-700 transition hover:bg-rose-50 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-70 md:w-auto"
            >
